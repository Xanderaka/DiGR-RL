...
if __name__ == '__main__':
    from src.signal_processing import plot_signals
    fs = 1000

    # Try this out with the Widar dataset data
    from src.data_utils import WidarDataset
    from pathlib import Path
    data = WidarDataset(Path("C:\Tue\Master\Jaar_2\graduation\code\DARLInG\data"), "train", "full", False, "stack")
    x = data[0][0]
    ...
    plot_signals(t, x[:, 0, 0], filtered_signal[:, 0, 0], "1", "2", "3")
